...
public class ActionBar extends RelativeLayout implements OnClickListener {
	 ...
	 * 
	 * This is ment to be used instead of the setHomeAction and does not draw a divider to the left
	...
	/*
	 * Emulating Honeycomb, setdisplayHomeAsUpEnabled takes a boolean and toggles whether the "home"
	 * view should have a little triangle indicating "up"
	 */
	...
	public static class ActionList extends LinkedList<Action> {
		private static final long serialVersionUID = -1540129380171462928L;
	}
	...
	public static class IntentAction extends AbstractAction {
		...
		public void performAction(View view) {
			try {
				...
				Toast.makeText(mContext, mContext.getText(R.string.actionbar_activity_not_found), Toast.LENGTH_SHORT)
						.show();
			}
		}
	}
